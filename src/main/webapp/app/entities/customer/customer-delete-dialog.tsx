...
export const CustomerDeleteDialog = (props: ICustomerDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mfoApp.customer.delete.question">Are you sure you want to delete this Customer?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="mfo-confirm-delete-customer" color="danger" onClick={confirmDelete}>
