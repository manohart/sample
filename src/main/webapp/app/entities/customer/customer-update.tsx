...
export const CustomerUpdate = (props: ICustomerUpdateProps) => {
  const [admin1Id, setAdmin1Id] = useState('0');
  const [admin2Id, setAdmin2Id] = useState('0');
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mfoApp.customer.home.createOrEditLabel">Create or edit a Customer</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="customer-code" type="text" name="code" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label for="customer-admin1">Admin 1</Label>
                <AvInput id="customer-admin1" type="select" className="form-control" name="admin1Id">
                  <option value="" key="0" />
                  {users
              ...
              <AvGroup>
                <Label for="customer-admin2">Admin 2</Label>
                <AvInput id="customer-admin2" type="select" className="form-control" name="admin2Id">
                  <option value="" key="0" />
                  {users
                    ? users.map(otherEntity => (
                        <option value={otherEntity.id} key={otherEntity.id}>
              ...
              <AvGroup>
                <Label for="customer-updatedBy">Updated By</Label>
                <AvInput id="customer-updatedBy" type="select" className="form-control" name="updatedById">
                  <option value="" key="0" />
                  {users
                    ? users.map(otherEntity => (
                        <option value={otherEntity.id} key={otherEntity.id}>
