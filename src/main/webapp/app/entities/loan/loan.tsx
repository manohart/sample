            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('loanId')}>
                  Loan Id <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('borrowerName')}>
                  Borrower Name <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {loanList.map((loan, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{loan.amount}</td>
                  <td>{loan.status}</td>
                  <td>{loan.updatedAt ? <TextFormat type="date" value={loan.updatedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{loan.updatedById ? loan.updatedById : ''}</td>
                  <td>{loan.customerId ? <Link to={`customer/${loan.customerId}`}>{loan.customerId}</Link> : ''}</td>
